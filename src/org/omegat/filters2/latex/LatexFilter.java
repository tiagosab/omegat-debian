...
public class LatexFilter extends AbstractFilter
{
     ...
     * @param in Source document
     * @param out Target document
     * @throws java.io.IOException
     */
    private void processLatexFile(BufferedReader in, Writer out)
	throws IOException {
    ...
    private String replaceOneArgNoText(LinkedList<String[]> substituted,
    ...
    private String replaceOneArgInlineText(LinkedList<String[]> substituted,
					   LinkedList<String> commands,
					   String par) {
	int counter = 0;
    ...
    private String replaceOneArgParText(LinkedList<String[]> substituted,
					LinkedList<String> commands,
					String par) {
	int counter = 0;
    ...
    private String replaceUnknownCommand(LinkedList<String[]> substituted,
					 LinkedList<String> commands,
					 String par) {
	int counter = 0;
