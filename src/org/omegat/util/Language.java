...
public class Language
{
     ...
     * <p>
     * The list contains all the ISO 639-1 codes.
     * When there are country variants (e.g., EN-US, EN-GB), they
     * have been kept only when there are more than one
     * variant (e.g., JA-JP has been left commented).
     */
